      ...
      <table width="560" cellpadding="0" cellspacing="0" role="presentation" style="max-width:560px;width:100%;background:#FAF7F1;border-radius:16px;overflow:hidden;">
        ...
        <tr>
          <td style="padding:52px 48px 8px;">
            ...
            <p style="margin:0 0 20px;font-size:14px;color:#1E1713;line-height:1.8;font-weight:300;">
              ${isPt
            ...
            <p style="margin:0 0 20px;font-size:14px;color:#806A58;line-height:1.8;font-weight:300;">
              ${isPt
        ...
        <tr>
          <td style="padding:32px 48px 40px;">
            <p style="margin:0 0 2px;font-size:13px;color:#1E1713;font-weight:400;">${artistConfig.name}</p>
